...
// PG_MIXER_CONFIG
    ...
    { "rpm_limiter_i_winddown",    VAR_UINT16 |  MASTER_VALUE,  .config.minmaxUnsigned = { 0, 1000 }, PG_MIXER_CONFIG, offsetof(mixerConfig_t, rpm_limiter_i_winddown) },
...
// position as displayed in the GUI.
    ...
    { "osd_esc_avg_rpm_pos",        VAR_UINT16  | MASTER_VALUE, .config.minmaxUnsigned = { 0, OSD_POSCFG_MAX }, PG_OSD_ELEMENT_CONFIG, offsetof(osdElementConfig_t, item_pos[OSD_ESC_AVG_RPM]) },
