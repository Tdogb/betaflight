...
// PG_MIXER_CONFIG
    ...
    { "rpm_limiter_full_regulation_accel_limit",        VAR_UINT16 |  MASTER_VALUE,  .config.minmaxUnsigned = { 1, 10000 }, PG_MIXER_CONFIG, offsetof(mixerConfig_t, rpm_limiter_acceleration_limit) },
    { "rpm_limiter_motor_kv",      VAR_UINT16 |  MASTER_VALUE,  .config.minmaxUnsigned = { 1, 50000 }, PG_MIXER_CONFIG, offsetof(mixerConfig_t, motor_kv) },
    ...
    { "rpm_limiter_full_regulation",    VAR_INT8   |  MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_MIXER_CONFIG, offsetof(mixerConfig_t, rpm_limiter_linearization) },
    { "rpm_limiter_full_regulation_idle_rpm",           VAR_UINT16 |  MASTER_VALUE,  .config.minmaxUnsigned = { 1, 50000 }, PG_MIXER_CONFIG, offsetof(mixerConfig_t, rpm_limiter_idle_rpm) },
