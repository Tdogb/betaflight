...
mixerRuntime.govenorPGain = mixerConfig()->govenor_p * 0.000015f;
mixerRuntime.govenorIGain = mixerConfig()->govenor_i * 0.001f * pidGetDT();
mixerRuntime.govenorDGain = mixerConfig()->govenor_d * 0.0000003f * pidGetPidFrequency();
mixerRuntime.govenorAccelerationLimit = mixerConfig()->govenor_acceleration_limit * 100.0f * pidGetDT();
mixerRuntime.govenorDecelerationLimit = mixerConfig()->govenor_deceleration_limit * 100.0f * pidGetDT();
